...
export const getById = async (request, response) => {
    ...
    try {
        ...
        response.setHeader('Content-Disposition', `attachment; filename=${file.name}.pdf`);
...
export const createPDF = async (request, response) => {
    ...
    try {
        ...
        await PDF_Files.create({ idUsoSuelo: request.body.idUsoSuelo, idVistoBueno: request.body.idVistoBueno, idZonificacion: request.body.idZonificacion, idGenerales: request.body.idGenerales, name: request.file.originalname, file_data: data });
